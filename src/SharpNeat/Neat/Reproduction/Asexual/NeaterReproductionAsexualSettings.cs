...
/// <summary>
/// Settings related to <see cref="NeaterReproductionAsexual{T}"/>.
/// </summary>
public class NeaterReproductionAsexualSettings
{
    /// <summary>
    ...
    /// Default constructor.
    /// </summary>
    public NeaterReproductionAsexualSettings()
    {
    }
    ...
    public NeaterReproductionAsexualSettings(NeaterReproductionAsexualSettings copyFrom)
    {
    ...
    public NeaterReproductionAsexualSettings CreateSimplifyingSettings()
    {
        ...
        var settings = new NeaterReproductionAsexualSettings(this)
        {
